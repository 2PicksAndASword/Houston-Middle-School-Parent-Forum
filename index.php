...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Parent Forums</title>
    </head>
    <body>
    	<br><div class="logo">
        	<img alt="forum" width="50" src="default/images/mustangicon.png"><font color="red" size="7">Houston Middle School</font><img alt="forum" width="50" src="default/images/mustangicon.png">
	    </div> 
        <div class="content">
<?php
...
<div class="box">
	...
	<div class="box_right">
    	<a href="list_pm.php">Your Personal Messages(<?php echo $nb_new_pm; ?>)</a> - <a href="profile.php?id=<?php echo $_SESSION['userid']; ?>"><?php echo htmlentities($_SESSION['username'], ENT_QUOTES, 'UTF-8'); ?></a> (<a href="login.php">Logout</a>)
    </div>
	<div class="clean"></div>
</div>
<?php
...
?>
		...
		<?php if($dnn1['position']>1){ ?><a href="move_category.php?action=up&id=<?php echo $dnn1['id']; ?>"><img width="25" src="<?php echo $design; ?>/images/up.png" alt="Move Up" /></a><?php } ?>
		<?php if($dnn1['position']<$nb_cats){ ?><a href="move_category.php?action=down&id=<?php echo $dnn1['id']; ?>"><img width="25" src="<?php echo $design; ?>/images/down.png" alt="Move Down" /></a><?php } ?>
		<a href="edit_category.php?id=<?php echo $dnn1['id']; ?>"><img width="25" src="<?php echo $design; ?>/images/edit.png" alt="Edit" /></a></td>
<?php
}
?>
    </tr>
